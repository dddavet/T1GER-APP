...
export const ReferralCode: React.FC<ReferralCodeProps> = ({ onSubmit, onSkip }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center space-y-12 mt-12">
      ...
      >
        <div className="bg-zinc-50 border border-zinc-200 rounded-[2rem] p-2 flex items-center shadow-xl focus-within:border-[#FF6B00]/50 focus-within:bg-zinc-50 transition-all duration-300">
          ...
          <input 
            ...
            className="flex-1 bg-transparent border-none text-zinc-800 font-bold px-4 py-4 outline-none placeholder:font-normal placeholder:text-zinc-600 uppercase"
            maxLength={8}
          />
          <button 
