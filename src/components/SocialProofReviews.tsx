  ...
  return (
    <div className="w-full flex flex-col items-center justify-center space-y-8 mt-4">
      ...
      <motion.div 
        ...
        className="bg-zinc-50 border border-zinc-200 rounded-3xl p-6 w-full flex items-center justify-center gap-6 shadow-xl"
      >
        ...
        <div className="flex flex-col items-center">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-3xl font-black text-zinc-800">4.9</span>
      ...
      >
        <h2 className="text-3xl font-black italic tracking-tighter uppercase leading-tight text-zinc-800 px-2 drop-shadow-md">
      ...
      <motion.div 
        ...
        className="bg-zinc-50 border border-zinc-200 rounded-3xl p-6 w-full relative overflow-hidden shadow-2xl"
      >
        {/* Glow */}
        <div className="absolute top-0 right-0 w-32 h-32 bg-[#FF6B00]/10 rounded-full blur-[40px] pointer-events-none" />
        
        <div className="flex items-center gap-4 mb-4 relative z-10">
          <div className="w-10 h-10 rounded-full bg-zinc-800 overflow-hidden border border-zinc-200">
            <img src="https://i.pravatar.cc/150?img=53" alt="Jake" className="w-full h-full object-cover" />
          </div>
          <div>
            <h4 className="font-bold text-zinc-800 text-sm">Alejandro Silva</h4>
            <div className="flex text-[#FF6B00] mt-1 gap-0.5">
              {[1,2,3,4,5].map(i => <Star key={i} size={10} fill="currentColor" strokeWidth={0} />)}
            </div>
          </div>
        </div>
        <p className="text-sm font-medium text-zinc-500 leading-relaxed italic relative z-10">
