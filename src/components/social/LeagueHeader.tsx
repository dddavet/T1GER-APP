...
const LEAGUES = [
  ...
  { id: 'silver', name: 'The Hunt', color: 'text-zinc-500', bg: 'bg-zinc-300/10', border: 'border-zinc-300/20' },
...
export const LeagueHeader = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-white shadow-sm rounded-[2rem] p-5 shadow-sm border-zinc-200 relative overflow-hidden"
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        <div className="flex items-center gap-4">
          <div className={`w-14 h-14 rounded-2xl ${currentLeague.bg} border ${currentLeague.border} flex items-center justify-center shadow-sm`}>
          ...
          <div className="space-y-1">
            ...
            <h2 className="text-2xl font-black italic uppercase tracking-tighter text-zinc-800 leading-none">
              {currentLeague.name}
            </h2>
          </div>
        </div>
        
        <button className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center border-zinc-200 hover:bg-zinc-50 transition-colors">
      ...
      <div className="mt-5 pt-4 border-t border-zinc-200 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] font-black uppercase text-zinc-500 tracking-widest">Promotion Zone</span>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-[10px] font-black text-zinc-800">#1</span>
