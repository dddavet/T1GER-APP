  ...
  return (
    <div className="w-full flex flex-col items-center justify-center mt-8 space-y-10">
      ...
      >
        ...
        <div className="w-48 h-48 rounded-full border border-zinc-200 bg-[#0a0a0c] flex items-center justify-center relative z-10 shadow-[0_0_40px_rgba(255,107,0,0.15)] overflow-hidden">
      ...
      <motion.div 
        ...
        className="bg-zinc-50 border border-zinc-200 rounded-3xl p-6 w-full text-center relative mt-6 shadow-2xl"
      >
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-[#1c1c1e] border border-zinc-200 flex items-center justify-center shadow-lg">
          <Lock size={14} className="text-[#FF6B00]" />
        </div>
        <h3 className="text-sm font-bold text-zinc-800 mb-2 mt-2">Tu privacidad y seguridad nos importan.</h3>
