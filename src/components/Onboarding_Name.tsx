  ...
  return (
    ...
    >
      <div className="pt-12 space-y-2">
        <h1 className="text-4xl font-black italic uppercase tracking-tighter text-[#FF7300]">IDENTIFY YOURSELF.</h1>
      ...
      <div className="flex-1 flex items-center justify-center">
        <input
          ...
          className="w-full bg-transparent text-center text-6xl font-mono text-zinc-800 placeholder:text-[#333] focus:outline-none caret-[#FF7300]"
          autoFocus
        />
      </div>
      ...
      <motion.button
        ...
        className={`w-full py-6 rounded-3xl font-black text-lg uppercase tracking-widest transition-all duration-300 ${
          callsign.length >= 2 ? 'bg-[#FF6B00] text-zinc-800 shadow-[0_0_20px_#FF6B00]' : 'bg-zinc-800 text-zinc-500 opacity-50'
        }`}
      >
        CONFIRM IDENTITY
      </motion.button>
