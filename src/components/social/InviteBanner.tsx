...
export const InviteBanner = () => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-[2.5rem] p-6 shadow-sm border border-accent/20"
      style={{
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-full bg-white shadow-sm-accent flex items-center justify-center shadow-sm">
            <Users className="w-5 h-5 text-accent" />
          </div>
          <h3 className="font-black text-lg italic uppercase tracking-tighter text-zinc-800">Pack <span className="text-accent">Recruitment</span></h3>
        </div>
        ...
        {/* Invite code display */}
        <div className="flex items-center gap-3 mb-6 bg-white shadow-sm rounded-[1.5rem] p-4 border-zinc-200 shadow-inner">
          ...
          <button
            ...
            className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all shadow-sm ${
              copied ? 'bg-accent text-black shadow-sm' : 'bg-zinc-50 text-zinc-500 border border-zinc-200'
            }`}
          >
        ...
        <div className="flex gap-3">
          <button
            onClick={handleShare}
            className="flex-1 flex items-center justify-center gap-2 bg-white text-black py-4 rounded-full font-black text-[10px] uppercase tracking-widest active:scale-[0.97] transition-all shadow-sm"
          >
